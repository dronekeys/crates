...
# Basic libraries
sudo apt-get install gradle build-essential doxygen libtinyxml2-dev libkml-dev libboost-all-dev cmake mercurial pkg-config \
 	...
 	playerc++ libxml2-dev libfreeimage-dev freeglut3-dev libgeographiclib-dev