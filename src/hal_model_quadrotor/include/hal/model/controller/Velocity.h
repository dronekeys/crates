...
namespace hal
{
    namespace controller
    {
        ...
        */
        class Velocity : public Controller<hal_model_quadrotor::State, hal_model_quadrotor::Control,
            hal_model_quadrotor::Velocity::Request, hal_model_quadrotor::Velocity::Response>
        {
