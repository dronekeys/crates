...
// Services
#include "sim/AddModel.h"
#include "sim/DelModel.h"
...
namespace gazebo
{
  ...
  /// \brief Both SDFs and converted URDFs get sent to this function for further manipulation from a ROS Service call
    bool addModel(sim::AddModel::Request &req,sim::AddModel::Response &res);

  /// \brief delete model given name
    bool delModel(sim::DelModel::Request &req,sim::DelModel::Response &res);
