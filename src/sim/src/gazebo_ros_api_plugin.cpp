...
GazeboRosApiPlugin::GazeboRosApiPlugin() :
  /* REMOVED BY ANDREW physics_reconfigure_initialized_(false), */
...
void GazeboRosApiPlugin::advertiseServices()
{
  ...
  ros::AdvertiseServiceOptions spawn_gazebo_model_aso =
    ros::AdvertiseServiceOptions::create<sim::SpawnModel>(
  ...
  ros::AdvertiseServiceOptions delete_aso =
    ros::AdvertiseServiceOptions::create<sim::DeleteModel>(
  ...
  ros::AdvertiseServiceOptions get_model_properties_aso =
    ros::AdvertiseServiceOptions::create<sim::GetModelProperties>(
  ...
  ros::AdvertiseServiceOptions get_model_state_aso =
    ros::AdvertiseServiceOptions::create<sim::GetModelState>(
  ...
  ros::AdvertiseServiceOptions get_world_properties_aso =
    ros::AdvertiseServiceOptions::create<sim::GetWorldProperties>(
  ...
  ros::AdvertiseServiceOptions get_joint_properties_aso =
    ros::AdvertiseServiceOptions::create<sim::GetJointProperties>(
  ...
  ros::AdvertiseServiceOptions get_link_properties_aso =
    ros::AdvertiseServiceOptions::create<sim::GetLinkProperties>(
  ...
  ros::AdvertiseServiceOptions get_link_state_aso =
    ros::AdvertiseServiceOptions::create<sim::GetLinkState>(
  ...
  ros::AdvertiseServiceOptions get_physics_properties_aso =
    ros::AdvertiseServiceOptions::create<sim::GetPhysicsProperties>(
  ...
  ros::AdvertiseOptions pub_link_states_ao =
    ros::AdvertiseOptions::create<sim::LinkStates>(
                                                           "link_states",10,
  ...
  ros::AdvertiseOptions pub_model_states_ao =
    ros::AdvertiseOptions::create<sim::ModelStates>(
                                                            "model_states",10,
  ...
  ros::AdvertiseServiceOptions set_link_properties_aso =
    ros::AdvertiseServiceOptions::create<sim::SetLinkProperties>(
  ...
  ros::AdvertiseServiceOptions set_physics_properties_aso =
    ros::AdvertiseServiceOptions::create<sim::SetPhysicsProperties>(
  ...
  ros::AdvertiseServiceOptions set_model_state_aso =
    ros::AdvertiseServiceOptions::create<sim::SetModelState>(
  ...
  ros::AdvertiseServiceOptions set_model_configuration_aso =
    ros::AdvertiseServiceOptions::create<sim::SetModelConfiguration>(
  ...
  ros::AdvertiseServiceOptions set_joint_properties_aso =
    ros::AdvertiseServiceOptions::create<sim::SetJointProperties>(
  ...
  ros::AdvertiseServiceOptions set_link_state_aso =
    ros::AdvertiseServiceOptions::create<sim::SetLinkState>(
  ...
  ros::SubscribeOptions link_state_so =
    ros::SubscribeOptions::create<sim::LinkState>(
                                                          "set_link_state",10,
  ...
  ros::SubscribeOptions model_state_so =
    ros::SubscribeOptions::create<sim::ModelState>(
                                                           "set_model_state",10,
  ...
  ros::AdvertiseServiceOptions apply_body_wrench_aso =
    ros::AdvertiseServiceOptions::create<sim::ApplyBodyWrench>(
  ...
  ros::AdvertiseServiceOptions apply_joint_effort_aso =
    ros::AdvertiseServiceOptions::create<sim::ApplyJointEffort>(
  ...
  ros::AdvertiseServiceOptions clear_joint_forces_aso =
    ros::AdvertiseServiceOptions::create<sim::JointRequest>(
  ...
  ros::AdvertiseServiceOptions clear_body_wrenches_aso =
    ros::AdvertiseServiceOptions::create<sim::BodyRequest>(
...
bool GazeboRosApiPlugin::spawnURDFModel(sim::SpawnModel::Request &req,
...
// DEPRECATED IN HYDRO
bool GazeboRosApiPlugin::spawnGazeboModel(sim::SpawnModel::Request &req,
                                          sim::SpawnModel::Response &res)
{
...
bool GazeboRosApiPlugin::spawnSDFModel(sim::SpawnModel::Request &req,
                                       sim::SpawnModel::Response &res)
{
  // incoming robot name
  std::string model_name = req.model_name;
...
bool GazeboRosApiPlugin::deleteModel(sim::DeleteModel::Request &req,
                                     sim::DeleteModel::Response &res)
{
...
bool GazeboRosApiPlugin::getModelState(sim::GetModelState::Request &req,
                                       sim::GetModelState::Response &res)
{
  gazebo::physics::ModelPtr model = world_->GetModel(req.model_name);
...
bool GazeboRosApiPlugin::getModelProperties(sim::GetModelProperties::Request &req,
                                            sim::GetModelProperties::Response &res)
{
  gazebo::physics::ModelPtr model = world_->GetModel(req.model_name);
  if (!model)
  {
...
bool GazeboRosApiPlugin::getWorldProperties(sim::GetWorldProperties::Request &req,
                                            sim::GetWorldProperties::Response &res)
{
...
bool GazeboRosApiPlugin::getJointProperties(sim::GetJointProperties::Request &req,
                                            sim::GetJointProperties::Response &res)
{
...
bool GazeboRosApiPlugin::getLinkProperties(sim::GetLinkProperties::Request &req,
                                           sim::GetLinkProperties::Response &res)
{
...
bool GazeboRosApiPlugin::getLinkState(sim::GetLinkState::Request &req,
                                      sim::GetLinkState::Response &res)
{
  gazebo::physics::LinkPtr body = boost::dynamic_pointer_cast<gazebo::physics::Link>(world_->GetEntity(req.link_name));
  gazebo::physics::LinkPtr frame = boost::dynamic_pointer_cast<gazebo::physics::Link>(world_->GetEntity(req.reference_frame));
...
bool GazeboRosApiPlugin::setLinkProperties(sim::SetLinkProperties::Request &req,
                                           sim::SetLinkProperties::Response &res)
{
  gazebo::physics::LinkPtr body = boost::dynamic_pointer_cast<gazebo::physics::Link>(world_->GetEntity(req.link_name));
  if (!body)
  {
...
bool GazeboRosApiPlugin::setPhysicsProperties(sim::SetPhysicsProperties::Request &req,
                                              sim::SetPhysicsProperties::Response &res)
{
...
bool GazeboRosApiPlugin::getPhysicsProperties(sim::GetPhysicsProperties::Request &req,
                                              sim::GetPhysicsProperties::Response &res)
{
  // supported updates
...
bool GazeboRosApiPlugin::setJointProperties(sim::SetJointProperties::Request &req,
                                            sim::SetJointProperties::Response &res)
{
...
bool GazeboRosApiPlugin::setModelState(sim::SetModelState::Request &req,
                                       sim::SetModelState::Response &res)
{
...
void GazeboRosApiPlugin::updateModelState(const sim::ModelState::ConstPtr& model_state)
{
  sim::SetModelState::Response res;
  sim::SetModelState::Request req;
  req.model_state = *model_state;
  /*bool success =*/ setModelState(req,res);
}

bool GazeboRosApiPlugin::applyJointEffort(sim::ApplyJointEffort::Request &req,
                                          sim::ApplyJointEffort::Response &res)
{
  gazebo::physics::JointPtr joint;
  for (unsigned int i = 0; i < world_->GetModelCount(); i ++)
  {
...
bool GazeboRosApiPlugin::clearJointForces(sim::JointRequest::Request &req,
                                          sim::JointRequest::Response &res)
{
...
bool GazeboRosApiPlugin::clearBodyWrenches(sim::BodyRequest::Request &req,
                                           sim::BodyRequest::Response &res)
{
...
bool GazeboRosApiPlugin::setModelConfiguration(sim::SetModelConfiguration::Request &req,
                                               sim::SetModelConfiguration::Response &res)
{
...
bool GazeboRosApiPlugin::setLinkState(sim::SetLinkState::Request &req,
                                      sim::SetLinkState::Response &res)
{
...
void GazeboRosApiPlugin::updateLinkState(const sim::LinkState::ConstPtr& link_state)
{
  sim::SetLinkState::Request req;
  sim::SetLinkState::Response res;
...
bool GazeboRosApiPlugin::applyBodyWrench(sim::ApplyBodyWrench::Request &req,
                                         sim::ApplyBodyWrench::Response &res)
{
...
{
  physics_reconfigure_set_client_ = nh_->serviceClient<sim::SetPhysicsProperties>("/gazebo/set_physics_properties");
  physics_reconfigure_get_client_ = nh_->serviceClient<sim::GetPhysicsProperties>("/gazebo/get_physics_properties");
