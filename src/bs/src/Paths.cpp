...
namespace gazebo
{
  class Paths : public SystemPlugin
  {
  ...
  public:
    ...
    Paths()
    {
      ...
      ros::package::getPlugins("bs","gazebo_media_path",gazebo_media_paths);
      ...
      ros::package::getPlugins("bs","plugin_path",plugin_paths);
      ...
      ros::package::getPlugins("bs","gazebo_model_path",model_paths);
      ...
      std::string gazeborc = ros::package::getPath("bs")+"/.do_not_use_gazeborc";
  ...
  GZ_REGISTER_SYSTEM_PLUGIN(Paths)
