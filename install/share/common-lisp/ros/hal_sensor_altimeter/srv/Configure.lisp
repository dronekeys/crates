...
(cl:in-package hal_sensor_altimeter-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <Configure-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Configure-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hal_sensor_altimeter-srv:<Configure-request> is deprecated: use hal_sensor_altimeter-srv:Configure-request instead.")))

(cl:ensure-generic-function 'samprate-val :lambda-list '(m))
(cl:defmethod samprate-val ((m <Configure-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hal_sensor_altimeter-srv:samprate-val is deprecated.  Use hal_sensor_altimeter-srv:samprate instead.")
  (samprate m))

(cl:ensure-generic-function 'sendrate-val :lambda-list '(m))
(cl:defmethod sendrate-val ((m <Configure-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hal_sensor_altimeter-srv:sendrate-val is deprecated.  Use hal_sensor_altimeter-srv:sendrate instead.")
  (sendrate m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Configure-request>)))
  ...
  "hal_sensor_altimeter/ConfigureRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Configure-request)))
  "Returns string type for a service object of type 'Configure-request"
  "hal_sensor_altimeter/ConfigureRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <Configure-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Configure-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hal_sensor_altimeter-srv:<Configure-response> is deprecated: use hal_sensor_altimeter-srv:Configure-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <Configure-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hal_sensor_altimeter-srv:success-val is deprecated.  Use hal_sensor_altimeter-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <Configure-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hal_sensor_altimeter-srv:status-val is deprecated.  Use hal_sensor_altimeter-srv:status instead.")
  (status m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Configure-response>)))
  ...
  "hal_sensor_altimeter/ConfigureResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Configure-response)))
  "Returns string type for a service object of type 'Configure-response"
  "hal_sensor_altimeter/ConfigureResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Configure)))
  ...
  "hal_sensor_altimeter/Configure")