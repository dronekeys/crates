...
(cl:in-package hal_sensor_compass-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Data>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Data)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hal_sensor_compass-msg:<Data> is deprecated: use hal_sensor_compass-msg:Data instead.")))

(cl:ensure-generic-function 't-val :lambda-list '(m))
(cl:defmethod t-val ((m <Data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hal_sensor_compass-msg:t-val is deprecated.  Use hal_sensor_compass-msg:t instead.")
  (t m))

(cl:ensure-generic-function 'm_x-val :lambda-list '(m))
(cl:defmethod m_x-val ((m <Data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hal_sensor_compass-msg:m_x-val is deprecated.  Use hal_sensor_compass-msg:m_x instead.")
  (m_x m))

(cl:ensure-generic-function 'm_y-val :lambda-list '(m))
(cl:defmethod m_y-val ((m <Data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hal_sensor_compass-msg:m_y-val is deprecated.  Use hal_sensor_compass-msg:m_y instead.")
  (m_y m))

(cl:ensure-generic-function 'm_z-val :lambda-list '(m))
(cl:defmethod m_z-val ((m <Data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hal_sensor_compass-msg:m_z-val is deprecated.  Use hal_sensor_compass-msg:m_z instead.")
  (m_z m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Data>)))
  ...
  (cl:format cl:nil "float64 t     # Time at which measurement was taken~%float64 m_x     # Body frame magnetic field strength X~%float64 m_y     # Body frame magnetic field strength Y~%float64 m_z     # Body frame magnetic field strength Z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Data)))
  "Returns full string definition for message of type 'Data"
  (cl:format cl:nil "float64 t     # Time at which measurement was taken~%float64 m_x     # Body frame magnetic field strength X~%float64 m_y     # Body frame magnetic field strength Y~%float64 m_z     # Body frame magnetic field strength Z~%~%~%"))
