...
namespace gpstk
{
   const string PRSolutionNoRotation::calfmt = string("%04Y/%02m/%02d %02H:%02M:%02S %P");
   const string PRSolutionNoRotation::gpsfmt = string("%4F %10.3g");
   const string PRSolutionNoRotation::timfmt = gpsfmt + string(" ") + calfmt;
   ...
   int PRSolutionNoRotation::PreparePRSolution(const CommonTime& Tr,
                                     vector<SatID>& Sats,
   ...
   int PRSolutionNoRotation::SimplePRSolution(const CommonTime& T,
   ...
   int PRSolutionNoRotation::RAIMCompute(const CommonTime& Tr,
                               vector<SatID>& Sats,
                               vector<SatID::SatelliteSystem>& Syss,
                               const vector<double>& Pseudorange,
                               const Matrix<double>& invMC,
   ...
   // -------------------------------------------------------------------------
   int PRSolutionNoRotation::DOPCompute(void) throw(Exception)
   {
      try {
   ...
   string PRSolutionNoRotation::outputValidString(int iret) throw()
   {
      ostringstream oss;
      if(iret != -99) {
   ...
   string PRSolutionNoRotation::outputNAVString(string tag, int iret, const Vector<double>& Vec)
      throw()
   {
      ostringstream oss;
   ...
   string PRSolutionNoRotation::outputPOSString(string tag, int iret, const Vector<double>& Vec)
      throw()
   {
      ostringstream oss;
   ...
   string PRSolutionNoRotation::outputCLKString(string tag, int iret) throw()
   {
      ostringstream oss;
   ...
   string PRSolutionNoRotation::outputRMSString(string tag, int iret) throw()
   {
      ostringstream oss;
   ...
   string PRSolutionNoRotation::outputString(string tag, int iret, const Vector<double>& Vec)
      throw()
   {
      ostringstream oss;
   ...
   string PRSolutionNoRotation::errorCodeString(int iret) throw()
   {
      string str("unknown");
   ...
   string PRSolutionNoRotation::configString(string tag) throw()
   {
      ostringstream oss;
   ...
   const Vector<double> PRSolutionNoRotation::PRSNullVector;
